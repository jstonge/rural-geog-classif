...
- spatial: uses spatial methods — GIS, remote sensing, cartography, or spatial statistics (GWR, spatial autocorrelation, point-pattern). Pick spatial over quant whenever a paper does both.
