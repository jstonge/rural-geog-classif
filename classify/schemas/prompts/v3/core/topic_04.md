...
Given a paper's title and abstract, identify which of the following topics the paper substantively covers. This is a **multi-label** task — select all that apply (typically 3–4 topics, up to 5 when warranted, fewer than 2 only for genuinely narrow papers).
